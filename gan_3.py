...
from utils_4 import discriminator, decoder
from generator import Generator
from utils_4 import encoder
...
class GAN(Generator):
    ...
    def __init__(self, hidden_size, batch_size, learning_rate,maps):
        self.input_tensor = tf.placeholder(tf.float32, [None, 32 * 32])
        self.xs2 = tf.placeholder(tf.float32, [None, 32 * 32])
        ...
        with arg_scope([layers.conv2d, layers.conv2d_transpose],
            ...
            with tf.variable_scope("model"):
                ...
                encode2 = tf.Variable(tf.random_normal([ 10,hidden_size], stddev=0.35), name="encode2")
