...
# X=images
dataInput=sio.loadmat('D:\ye\lowRankSpectralClustering\datasets\orl_2.mat')
batch=40;
batchSize=10;
...
model = GAN(hidden_size, batchSize, 1e-2,maps)
numIter=0
loss_value=0
training_loss=0
training_loss1=0
...
while numIter<20:
    ...
    for i in range(batch):
        ...
        loss_value = model.update_params1(images, images, maps1)
    ...
    # print('First moment:',training_loss,'Second moment:',training_loss1,'Variational loss:',P)
